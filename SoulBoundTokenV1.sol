//Trying out different versions of SBTs, so far I like this code compared to other SBTs I have coded/referenced on github
//More SBT versions will be added as I begin to construct the project
...
contract Web3ClubTourToken is ERC721, ERC721URIStorage, Ownable{
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) pure override internal{
